...
function BodyProductSell() {
    let list = document.getElementsByClassName('item-slider-carousel');
    let listimg = [
        { img: 'https://cdn.wallpapersafari.com/37/15/L8EIpF.jpg', urlvideo: '/videos/introacer.mp4' },
        {
        ...
        {
            img: 'https://thienthanhlimo.com/wp-content/uploads/2022/05/101-anh-sieu-xe-4k-tai-free-lam-hinh-nen-dt-may-tinh-52.jpg',
        ...
        { img: 'https://wallpapercave.com/wp/2wJfqOP.jpg', urlvideo: '/videos/introasus.mp4' },
        { img: 'https://cdn.wallpapersafari.com/37/15/L8EIpF.jpg', urlvideo: '/videos/introasus.mp4' },
        { img: 'https://wallpapercave.com/wp/2wJfqOP.jpg', urlvideo: '/videos/introasus.mp4' },
        { img: 'https://cdn.wallpapersafari.com/37/15/L8EIpF.jpg', urlvideo: '/videos/introasus.mp4' },
        { img: 'https://wallpapercave.com/wp/2wJfqOP.jpg', urlvideo: '/videos/introasus.mp4' },
        { img: 'https://cdn.wallpapersafari.com/37/15/L8EIpF.jpg', urlvideo: '/videos/introasus.mp4' },
    ...
    function active1_0() {
        const a = listimg.map((e, index) => {
            if (index == listimg.length - 1) {
                return (
                    <li key={index} className="item-carousel-prev prev-carousel" onClick={bamnelui}>
                        <img src={e.img}></img>
                    </li>
                );
            }
        ...
        const b = listimg.map((e, index) => {
            ...
            if (index == 1) {
                return (
                    <li key={index} className="item-carousel-next next-carousel" onClick={bamne}>
                        <img src={e.img}></img>
                    </li>
                );
    ...
    function active2_0() {
        const a = listimg.map((e, index) => {
            if (index == listimg.length - 1) {
                return (
                    <li key={index} className="item-carousel-prev back-prev-carousel" onClick={bamnelui}>
                        <img src={e.img}></img>
                    </li>
                );
            }
        ...
        const b = listimg.map((e, index) => {
            ...
            if (index == 1) {
                return (
                    <li key={index} className="item-carousel-next back-next-carousel" onClick={bamne}>
                        <img src={e.img}></img>
                    </li>
                );
            } else if (index != listimg.length - 1) {
    ...
    useEffect(() => {
        ...
        if (active == 1) {
            ...
            if (curr > 1 && curr < listimg.length - 1) {
                ...
                item_carousels[item_carousels.length - 1].classList = 'item-carousel-prev2';
            }
            setTimeout(() => {
    ...
    return (
        <div className="slider-body">
                ...
                {active == 0
                    ? listimg.map((e, index) => {
                          if (curr == 0) {
                              ...
                              if (index == listimg.length - 1) {
                                  return (
                                      <li key={index} className="item-carousel-prev" onClick={bamnelui}>
                                          <img src={e.img}></img>
                                      </li>
                                  );
                              }
                              if (index == 1) {
                                  return (
                                      <li key={index} className="item-carousel-next" onClick={bamne}>
                                          <img src={e.img}></img>
                                      </li>
                                  );
                              }
            ...
            <div className="bg-slider">
                ...
                />
                {/* <img className="video-slider" src={listimg[curr].img}></img> */}
