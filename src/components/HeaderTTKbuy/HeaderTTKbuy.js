...
function HeaderTTKbuy() {
    ...
    const arrowbottom = document.getElementsByClassName('arrow-header-ttkbuy-bottom');
    ...
    const menuwrapttkbuy = document.getElementsByClassName('menu-wrapper-ttkbuy')[0];
    const backdropttkbuy = document.getElementsByClassName('backdrop-menu-ttkbuy')[0];
    const backdropttkbuy2 = document.getElementsByClassName('backdrop-search-ttkbuy')[0];
    const formsearchttkbuy = document.getElementsByClassName('form-search-ttkbuy')[0];
    const closemenu = document.getElementsByClassName('button-close-search-ttkbuy')[0];
    const bodyfull = document.getElementsByTagName('body')[0];
    const header_ttkbuy = document.querySelector('.header-ttkbuy');
    ...
    const onClickarrow = () => {
        if (active === false) {
            ...
            document.getElementsByClassName('header-ttkbuy-bottom')[0].classList.add('active');
            setactive(true);
            setreset(true);
        } else {
            arrowbottom[0].classList.remove('arrowdown');
            arrowbottom[0].classList.add('arrowup');
            document.getElementsByClassName('header-ttkbuy-bottom')[0].classList.remove('active');
            setactive(false);
        }
    };
    ...
    return (
        ...
        >
            <div className="header-ttkbuy-top">
                <ul className="navleft-menu-ttkbuy">
                    <li className="item-navleft-menu-ttkbuy">
                        {tab ? (
                            <AiOutlineClose className="button-close-ttkbuy" onClick={on_off_menu} />
                        ) : (
                ...
                <ul className="navright-menu-ttkbuy">
                    ...
                    >
                        <FaShoppingCart />
                        <span>Cart</span>
                        <div className={hovercart ? 'cart-drawer-ttkbuy active' : 'cart-drawer-ttkbuy'}>
            ...
            <div className="header-ttkbuy-bottom">
                <ul className="navbottom-menu-ttkbuy">
